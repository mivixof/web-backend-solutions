...
<html>
    ...
    <body class="web-backend-opdracht">
        ...
        <section class="body">
            ...
            <ul>
                ...
                <li>Wanneer iemand op 'genereer een paswoord' drukt moet er een paswoord gegenereerd worden.
                    <ul>
                        ...
                        <li>Zorg ervoor dat wanneer er een paswoord gegenereerd wordt dit ook zichtbaar, dus geen ********, zal zijn voor gebruiker</li>
                    ...
                    <ul>
                        ...
                        <li>Controleer of het e-mailadres geldig is
                            ...
                            <ul>
                                ...
                                <li>Als je dit manueel mag doen, mag dit. Het is voldoende om te controleren of het een ‘@’ en minstens één ‘.’ bevat. Best toch even zoeken, PHP heeft hiervoor speciale functies die veel manueel werk kunnen vermijden.</li>
                        ...
                        <li>Controleer alvorens de data toe te voegen of het e-mailadres reeds in de database users voorkomt.
                            ...
                            <ul>
                                <li>Als de het e-mailadres reeds voorkomt, toon dan een gepaste boodschap dmv de <code>$_SESSION['notification']</code> en redirect naar registratie-form.php</li>
                            </ul>
                        </li>
                        ...
                        <li>Als het e-mailadres geldig is en het komt niet voor in de database, mag de gebruiker aan de database toegevoegd worden.
                            <ul>
                                ...
                                <li>Voeg het e-mailadres, de willekeurig gegenereerde salt en het salted password toe aan de database onder de tabel users. Zorg ervoor dat <code>last_login_time</code> ook geüpdated wordt dmv de SQL-command <code>NOW()</code></li>
                            </ul>
                        </li>
            ...
            <ul>
                <li>Controleer of de cookie met key <code>login</code> geset is. Als deze niet geset is moet er automatisch geredirect worden naar login-form.php (<a href="#login">zie stap 4</a>)</li>

                <li>Haal de juiste salt op uit de database users-tabel</li>

                <li>Controleer of het de hash van het e-mailadres geconcateneerd met de salt uit de database gelijk is aan de hash-key na de komma uit de cookie.</li>

                <li>Als dit het geval is, mag de inhoud van het dashboard getoond worden, anders moet de cookie <code>unset</code> worden en moet er geredirect worden naar de login pagina.</li>
            ...
            <ul>
                ...
                <li>De pagina login-process.php
                    <ul>
                        ...
                        <li>Haal de salt op uit de database zoals bij het de pagina registratie-process.php</li>

                        <li> Controlleer of de hash van het (ingevulde paswoord + salt), gelijk is aan de password-kolom uit de database</li>
