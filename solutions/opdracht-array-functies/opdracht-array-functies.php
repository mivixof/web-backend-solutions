    ...
    <body class="web-backend-opdracht">
        ...
        <section class="body">
            ...
            <ul>
                ...
                <li>Laat het script berekenen hoeveel elementen er in de array zitten en druk af naar het scherm, namelijk <?echo "$amount";?> </li>

                <li>Maak het mogelijk om met een variabele <code>$search</code> een dier te zoeken in de array, druk tevens een gepaste boodschap af <?php echo "$text";?>.</li>
