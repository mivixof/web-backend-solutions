...
function uploadCheck($tarw, $tarh)
{
	...
	*/
	...
	if ((($type == 'image/gif' )||( $type == 'image/jpeg') || ($type == 'image/png')  || ($type == 'image/jpg')) && $size <= 5000000) 
	{
...
var_dump($croppedimg);
		...
		imagejpeg($thumb, (realpath('img') . '\\thumb-' . $date . $extra . '_' . $name . '.jpg'), 100);

	}
	else 
	{
		return $message = "nonononononnoononnoonononononono";
	}
}
