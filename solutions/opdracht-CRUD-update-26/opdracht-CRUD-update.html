...
<html>
    ...
    <body class="web-backend-opdracht">
        ...
        <section class="body">
            ...
            <ul>
                <li>Zorg ervoor dat enkel de invulvelden die aangepast zijn, geüpdated worden.</li>
                ...
                <li>Zorg ervoor dat wanneer er een kolom wordt toegevoegd aan de database (bv. Telefoonnummer), deze automatisch aan het invulveld wordt toegevoegd zonder dat je dit moet bijprogrammeren in PHP.
                    <ul>
                        ...
                        <li>Bij een goede database zijn de kolomnamen rechtstreeks bruikbaar als labels bij de inputvelden. Spaties worden vervangen door underscores. Zo is het mogelijk om met php deze underscores te vervangen door spaties en wordt de kolomnaam weer bruikbaar als label. Dit is geen must, maar zo is het geheel Ddnamisch!</li>
            ...
            <ul>
                ...
                <li>Voorzie naast elke rij een knop "gebruik deze data". Wanneer er op deze knop gedrukt wordt, moet de data van deze rij de huidige data van de brouwerij overschrijven.
                    <ul>
