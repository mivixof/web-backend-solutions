...
<html>
    ...
    <?php endif ?>
<p><a href="<?= HOST ?>oplossing-security-login-dashboard.php">">Terug naar dashboard</a> | Ingelogd als <?= $_SESSION ['email'] ?> | <a href="<?= HOST ?>oplossing-security-login-logout-process.php">Uitloggen</a></p>
    <h1>Dashboard</h1>
 	<ul>
